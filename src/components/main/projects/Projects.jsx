      ...
      <div className={styles.devices}>
        <div className={styles.Iphone}>
          <div className={styles.contain_image_phone}>
            <img loading={"lazy"} src={mobile ? `${IMAGE_URL}${mobile}` : mobi.src} alt={'projects'} className={styles.image}
            />
          </div>
        </div>
        <span></span>
        <div className={styles.Ipad}>
          <div className={styles.contain_image}>
            <img loading={"lazy"} src={tablet ? `${IMAGE_URL}${tablet}` : desktop.src} alt={'projects'} className={`${styles.image} ${styles.index}`}/>
          </div>
        </div>
      </div>
    </div>
